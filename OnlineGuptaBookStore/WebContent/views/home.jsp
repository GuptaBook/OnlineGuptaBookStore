  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="CusRegis.jsp">SignUp</a></li>
        <li><a href="LoginPage.jsp">Login</a></li>
        <li><a href="#contact">Contact</a></li>
        <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="#">Book Category
          <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="insertsubject.jsp">Subject</a></li>
            <li><a href="insertauthor.jsp">Author</a></li>
          </ul>
        </li>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="book1.jpg" alt="book1" width="200" height="200">
      ...
      <div class="item">
        <img src="book2.png" alt="book2" width="200" height="200">
        <div class="carousel-caption">
      ...
      <div class="item">
        <img src="book3.jpg" alt="book3" width="200" height="200">
        <div class="carousel-caption">
          <h3>Secret</h3>
        </div>      
      </div>
